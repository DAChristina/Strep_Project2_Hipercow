...
matplot(time, t(x[4, , ]), col = cols[["n_SI_daily"]], type = "l",
        xlab = "Time", ylab = "Number of individuals",lty = 1)
matlines(time, incidence$cases, col = "steelblue", lty = 1, lwd = 5)
legend("right", legend = c("Model", "Data"), col = c("#cc0099", "steelblue"), pch = c(19, 19), bty = "n")