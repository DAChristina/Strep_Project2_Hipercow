...
# bactdating_obj <- readRDS("mcmc_bacdating.rds")
...
# Write output
output_fn = paste0(strain_name,"_model_",model_index,"_adaptation_",ifelse(adapt_val,"true","false"),"_rep_",rep,"_mlesky.csv")
